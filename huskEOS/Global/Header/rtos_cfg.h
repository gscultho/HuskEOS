...
#define RTOS_CONFIG_PRESLEEP_FUNC                   (RTOS_CONFIG_TRUE)   /* If enabled, hook function app_OSPreSleepFcn() can be defined in application. */
#define RTOS_CONFIG_POSTSLEEP_FUNC                  (RTOS_CONFIG_TRUE)   /* If enabled, hook function app_OSPostSleepFcn() can be defined in application. */
